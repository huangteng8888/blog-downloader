...
POSTS_DIR = Path("/mnt/data/blog-downloader/1285707277/posts")
OUTPUT_DIR = Path("/mnt/data/blog-downloader/1285707277/blog-graph")
...
def analyze_batch(articles: list[dict]) -> str:
    ...
    prompt = f"""你是股市风云股票技术分析专家。分析以下博客文章，提取核心概念、理论体系和技术分析方法。
